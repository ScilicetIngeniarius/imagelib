...
int main(){
	...
	cout<<"Pixel value: "<< static_cast<unsigned>(get_pixel_value(100, 150, 1, 1))<<std::endl; //"__Image_object__".get_pixel_value(x,y,z,c);

	//Set
	for(int i=0;i<100;i++)
	{
	image_crated.set_pixel_value(i, i, 1, 1, 0); //"__Image_object__".set_pixel_value(x,y,z,c,pixel value);
	}
