...
\ganttbar[progress=50]{\textbf{2.1} Operaciones Arimeticas y Logicas (Erick)}{3}{6} \\
\ganttbar[progress=20]{\textbf{2.2} Suavizacion (Filtros paso bajo) (Felipe)}{4}{7} \\
\ganttbar[progress=20]{\textbf{2.3} Contrastacion (Filtros paso alto) (Fabian)}{4}{7} \\

\ganttgroup[]{3. Filtros en el Dominio de la Frecuencia}{7}{12} \\
\ganttbar[]{\textbf{3.1} Transformada de Fourier (Todos)}{7}{9} \\
\ganttbar[]{\textbf{3.2} Suavizacion (Filtros paso bajo) (Felipe)}{9}{11} \\
\ganttbar[]{\textbf{3.3} Contrastacion (Filtros paso alto) (Fabian)}{9}{11} \\
\ganttbar[]{\textbf{2.1} Butterworth, Prewitt (Erick)}{10}{12} \\
...
\ganttbar[]{\textbf{4.1} Dilatacion Rango Dinamico (Erick) }{10}{11} \\
\ganttbar[]{\textbf{4.2} Negativo de la imagen (Felipe)}{10}{11} \\
\ganttbar[]{\textbf{4.3} Transformaciones Logaritmicas)(Fabian)}{11}{12} \\
\ganttbar[]{\textbf{4.4} Corte del nivel de gris (Fabian)}{11}{13} \\

\ganttgroup[]{5. Creacion de documentacion y presentacion (Todos)}{14}{17} \\
